...
func (mfs *machineFingerprintService) TrackMachine(licenseKey string, fingerprint string, machineName string, osInfo string) error {
	...
	// Log audit event
	mfs.auditSvc.LogAction("MACHINE_TRACKED", "LicenseActivation", activation.ID, &license.UserID, nil, nil)
...
func (mfs *machineFingerprintService) DeactivateMachine(licenseKey string, fingerprint string) error {
	...
	// Log audit event
	mfs.auditSvc.LogAction("MACHINE_DEACTIVATED", "LicenseActivation", activation.ID, &license.UserID, nil, nil)
